...
class ControllerAccountLogin extends Controller
{
    ...
    public function index()
    {
        ...
        if (isset($this->request->get['redirect'])) {
            $data['telegram_redirect_url'] = TELEGRAM_REDIRECT_URL . '&redirect=' . $this->request->get['redirect'];
        } else {
    ...
    public function telegram()
    {
        ...
        if (isset($this->request->get['redirect'])) {
            $this->response->redirect($this->url->link($this->request->get['redirect'], 'language=' . $this->config->get('config_language')));
            return;
        }
        // redirect to
